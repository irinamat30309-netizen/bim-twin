/* BIM Twin — modern line-icon set (official Lucide 2026 geometry, stroke 2). No deps. */
(function () {
  'use strict';
  var P = {
    ...
    'sliders': '<path d="M21 4H14M10 4H3M21 12H12M8 12H3M21 20H16M12 20H3"/><path d="M14 2v4M8 10v4M16 18v4"/>',
    ...
    'walk': '<path d="M7 21l3 -4"/><path d="M16 21l-2 -4l-3 -3l1 -6"/><path d="M6 12l2 -3l4 -1l3 3l3 1"/><circle cx="12" cy="5" r="1"/>',
    'zoom-in': '<circle cx="10" cy="10" r="7"/><path d="M7 10h6M10 7v6"/><path d="M21 21l-6 -6"/>',
    'zoom-out': '<circle cx="10" cy="10" r="7"/><path d="M7 10h6"/><path d="M21 21l-6 -6"/>',
    'eye': '<path d="M2 12s3.5 -7 10 -7s10 7 10 7s-3.5 7 -10 7s-10 -7 -10 -7"/><circle cx="12" cy="12" r="3"/>',
    'eye-off': '<path d="M10.585 10.587a2 2 0 0 0 2.829 2.828"/><path d="M16.681 16.673a8.717 8.717 0 0 1 -4.681 1.327c-6.5 0 -10 -6 -10 -6a13.9 13.9 0 0 1 3.53 -4.352m3.058 -1.55a8.717 8.717 0 0 1 3.412 -.098c6.5 0 10 6 10 6a13.9 13.9 0 0 1 -1.67 2.336"/><path d="M3 3l18 18"/>',
    ...
    'move': '<path d="M18 9l3 3l-3 3"/><path d="M15 12h6"/><path d="M6 9l-3 3l3 3"/><path d="M3 12h6"/><path d="M9 18l3 3l3 -3"/><path d="M12 15v6"/><path d="M15 6l-3 -3l-3 3"/><path d="M12 3v6"/>',
  ...
  function ic(name, size) {
    ...
    var p = P[name];
    if (!p) p = P['square'];
    return '<svg class="ic" viewBox="0 0 24 24" width="' + size + '" height="' + size + '" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' + p + '</svg>';
  }
  window.ICON = ic;
})();
