...
**Статус:** этапы продвинуты, но ни один из трёх не принят и не завершён. Это кодовое продолжение текущего review-пакета 1.1.17, а не обещание полного паритета с LixelStudio/CoProcess. Локальные изменения не отправлялись в hosted CI; тестировалась Linux-среда, не Windows/Electron-пакет.
